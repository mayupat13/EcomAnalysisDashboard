...
// Fix the session URL issue by setting the NEXTAUTH_URL correctly
// Use a more reliable approach to set the default URL
const baseUrl =
...
export const authOptions: NextAuthOptions = {
  ...
  // Add these settings to fix fetch errors
